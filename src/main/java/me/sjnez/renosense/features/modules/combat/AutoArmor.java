...
extends Module {
    ...
    public void onTick() {
        ...
        if (this.taskList.isEmpty()) {
            ...
            ItemStack chest;
            int slot4;
            if (this.mendingTakeOff.getValue().booleanValue() && InventoryUtil.holdingItem(ItemExpBottle.class) && AutoArmor.mc.gameSettings.keyBindUseItem.isKeyDown() && AutoArmor.mc.world.field_73010_i.stream().noneMatch(e -> e != AutoArmor.mc.player && !RenoSense.friendManager.isFriend(e.getName()) && AutoArmor.mc.player.func_70032_d((Entity)e) <= (float)this.closestEnemy.getValue().intValue()) && !this.flag) {
                int goods;
                int dam;
                int takeOff = 0;
                ...
                if (!this.flag) {
                    ItemStack itemStack1 = AutoArmor.mc.player.field_71069_bz.getSlot(5).getStack();
                    ...
                    ItemStack itemStack2 = AutoArmor.mc.player.field_71069_bz.getSlot(6).getStack();
                    ...
                    ItemStack itemStack3 = AutoArmor.mc.player.field_71069_bz.getSlot(7).getStack();
                    ...
                    ItemStack itemStack4 = AutoArmor.mc.player.field_71069_bz.getSlot(8).getStack();
            ...
            this.flag = false;
            ItemStack helm = AutoArmor.mc.player.field_71069_bz.getSlot(5).getStack();
            ...
            if ((chest = AutoArmor.mc.player.field_71069_bz.getSlot(6).getStack()).getItem() == Items.AIR && (slot3 = InventoryUtil.findArmorSlot(EntityEquipmentSlot.CHEST, this.curse.getValue(), true)) != -1) {
                this.getSlotOn(6, slot3);
            }
            if ((legging = AutoArmor.mc.player.field_71069_bz.getSlot(7).getStack()).getItem() == Items.AIR && (slot2 = InventoryUtil.findArmorSlot(EntityEquipmentSlot.LEGS, this.curse.getValue(), true)) != -1) {
                this.getSlotOn(7, slot2);
            }
            if ((feet = AutoArmor.mc.player.field_71069_bz.getSlot(8).getStack()).getItem() == Items.AIR && (slot = InventoryUtil.findArmorSlot(EntityEquipmentSlot.FEET, this.curse.getValue(), true)) != -1) {
    ...
    private Map<Integer, ItemStack> getInventorySlots(int current, int last) {
        ...
        while (current <= last) {
            fullInventorySlots.put(current, (ItemStack)AutoArmor.mc.player.field_71069_bz.getInventory().get(current));
            ++current;
        }
