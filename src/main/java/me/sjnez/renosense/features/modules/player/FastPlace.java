...
extends Module {
    ...
    public void onUpdate() {
        ...
        if (this.PacketCrystal.getValue().booleanValue() && FastPlace.mc.gameSettings.keyBindUseItem.isKeyDown()) {
            boolean offhand;
            boolean bl = offhand = FastPlace.mc.player.func_184592_cb().getItem() == Items.END_CRYSTAL;
            if (offhand || FastPlace.mc.player.func_184614_ca().getItem() == Items.END_CRYSTAL) {
