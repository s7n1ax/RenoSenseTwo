...
extends Feature {
    ...
    public void enable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(this.getNotifierOn(), 1);
    ...
    public void disable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(this.getNotifierOff(), 1);
        }
        this.onToggle();
        this.onDisable();
    }
