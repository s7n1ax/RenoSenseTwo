...
extends Module {
    ...
    public Setting<SettingMode> mode = this.register(new Setting<SettingMode>("Mode", SettingMode.Place));
    private final Setting<Integer> red = this.register(new Setting<Integer>("Red", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Integer> green = this.register(new Setting<Integer>("Green", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Integer> blue = this.register(new Setting<Integer>("Blue", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Integer> alpha = this.register(new Setting<Integer>("Alpha", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Integer> boxAlpha = this.register(new Setting<Integer>("BoxAlpha", Integer.valueOf(125), Integer.valueOf(0), Integer.valueOf(255), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Float> lineWidth = this.register(new Setting<Float>("LineWidth", Float.valueOf(1.0f), Float.valueOf(0.1f), Float.valueOf(5.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> render = this.register(new Setting<Boolean>("Render", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> renderDmg = this.register(new Setting<Boolean>("RenderDmg", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> box = this.register(new Setting<Boolean>("Box", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> outline = this.register(new Setting<Boolean>("Outline", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Integer> cRed = this.register(new Setting<Object>("OL-Red", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue() != false && this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Integer> cGreen = this.register(new Setting<Object>("OL-Green", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue() != false && this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Integer> cBlue = this.register(new Setting<Object>("OL-Blue", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue() != false && this.mode.currentEnumName().equalsIgnoreCase("Other")));
    private final Setting<Integer> cAlpha = this.register(new Setting<Object>("OL-Alpha", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.outline.getValue() != false && this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> colorSync = this.register(new Setting<Object>("ColorSync", Boolean.valueOf(false), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> rotate = this.register(new Setting<Boolean>("Rotate", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<SwingMode> swingMode = this.register(new Setting<SwingMode>("Swing", SwingMode.MainHand, v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> autoswitch = this.register(new Setting<Boolean>("AutoSwitch", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<SwitchMode> switchmode = this.register(new Setting<SwitchMode>("SwitchMode", SwitchMode.Normal, v -> this.autoswitch.getValue() != false && this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> silentSwitch = this.register(new Setting<Boolean>("SilentSwitchHand", Boolean.valueOf(true), v -> this.switchmode.getValue() == SwitchMode.Silent && this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Float> targetRange = this.register(new Setting<Float>("TargetRange", Float.valueOf(4.0f), Float.valueOf(1.0f), Float.valueOf(12.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Other")));
    public Setting<Boolean> sound = this.register(new Setting<Boolean>("Sequential", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Boolean> place = this.register(new Setting<Boolean>("Place", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Float> placeDelay = this.register(new Setting<Float>("PlaceDelay", Float.valueOf(4.0f), Float.valueOf(0.0f), Float.valueOf(300.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Float> placeRange = this.register(new Setting<Float>("PlaceRange", Float.valueOf(4.0f), Float.valueOf(0.1f), Float.valueOf(7.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Boolean> opPlace = this.register(new Setting<Boolean>("1.13 Place", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Boolean> ignoreUseAmount = this.register(new Setting<Boolean>("IgnoreUseAmount", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Integer> wasteAmount = this.register(new Setting<Integer>("UseAmount", Integer.valueOf(4), Integer.valueOf(1), Integer.valueOf(5), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Float> facePlace = this.register(new Setting<Float>("FacePlaceHP", Float.valueOf(4.0f), Float.valueOf(0.0f), Float.valueOf(36.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Boolean> facePlaceSword = this.register(new Setting<Boolean>("FacePlaceSword", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Float> minDamage = this.register(new Setting<Float>("MinDamage", Float.valueOf(4.0f), Float.valueOf(0.1f), Float.valueOf(20.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    public Setting<Float> minArmor = this.register(new Setting<Float>("MinArmor", Float.valueOf(4.0f), Float.valueOf(0.1f), Float.valueOf(80.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Place")));
    private final Setting<Integer> attackFactor = this.register(new Setting<Integer>("PredictDelay", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(200), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Boolean> explode = this.register(new Setting<Boolean>("Break", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Boolean> packetBreak = this.register(new Setting<Boolean>("PacketBreak", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Boolean> predicts = this.register(new Setting<Boolean>("Predict", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Float> breakDelay = this.register(new Setting<Float>("BreakDelay", Float.valueOf(4.0f), Float.valueOf(0.0f), Float.valueOf(300.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Float> breakRange = this.register(new Setting<Float>("BreakRange", Float.valueOf(4.0f), Float.valueOf(0.1f), Float.valueOf(7.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Float> breakWallRange = this.register(new Setting<Float>("BreakWallRange", Float.valueOf(4.0f), Float.valueOf(0.1f), Float.valueOf(7.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Boolean> suicide = this.register(new Setting<Boolean>("AntiSuicide", Boolean.valueOf(true), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Float> breakMaxSelfDamage = this.register(new Setting<Float>("BreakMaxSelf", Float.valueOf(4.0f), Float.valueOf(0.1f), Float.valueOf(12.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    public Setting<Float> breakMinDmg = this.register(new Setting<Float>("BreakMinDmg", Float.valueOf(4.0f), Float.valueOf(0.1f), Float.valueOf(7.0f), v -> this.mode.currentEnumName().equalsIgnoreCase("Break")));
    ...
    public AutoCrystal() {
        super("AutoCrystal", "Places crystals around you and hits them.", Module.Category.COMBAT, true, false, false);
    }
    ...
    public void onCrystal() {
        ...
        if (this.placeTimer.passedMs(this.placeDelay.getValue().longValue()) && this.place.getValue().booleanValue()) {
            ...
            for (BlockPos blockPos : this.placePostions(this.placeRange.getValue().floatValue())) {
                ...
                if (targetDmg < (double)this.minDamage.getValue().floatValue() && (this.facePlaceSword.getValue() != false ? this.target.getAbsorptionAmount() + this.target.getHealth() > this.facePlace.getValue().floatValue() : AutoCrystal.mc.player.getHeldItemMainhand().getItem() instanceof ItemSword || this.target.getAbsorptionAmount() + this.target.getHealth() > this.facePlace.getValue().floatValue()) && (this.facePlaceSword.getValue() == false ? AutoCrystal.mc.player.getHeldItemMainhand().getItem() instanceof ItemSword || !this.armor : !this.armor)) continue;
                double selfDmg = this.calculateDamage((double)blockPos.getX() + 0.5, (double)blockPos.getY() + 1.0, (double)blockPos.getZ() + 0.5, AutoCrystal.mc.player);
                if (d + (this.suicide.getValue() != false ? 2.0 : 0.5) >= (double)(AutoCrystal.mc.player.getHealth() + AutoCrystal.mc.player.getAbsorptionAmount()) && selfDmg >= targetDmg && targetDmg < (double)(this.target.getHealth() + this.target.getAbsorptionAmount()) || !(damage < targetDmg)) continue;
                this.pos = blockPos;
                damage = targetDmg;
            }
            if (damage == 0.5) {
            ...
            if (this.hotBarSlot != -1 && this.autoswitch.getValue().booleanValue() && !AutoCrystal.mc.player.isPotionActive(MobEffects.WEAKNESS) && this.switchmode.getValue() == SwitchMode.Normal && !this.silentSwitch.getValue().booleanValue()) {
                AutoCrystal.mc.player.inventory.currentItem = this.hotBarSlot;
            }
            int slot = InventoryUtil.findHotbarBlock(ItemEndCrystal.class);
            int old = AutoCrystal.mc.player.inventory.currentItem;
            EnumHand hand = null;
            if (this.switchmode.getValue() == SwitchMode.Silent && slot != -1) {
                if (AutoCrystal.mc.player.isHandActive() && this.silentSwitch.getValue().booleanValue()) {
            ...
            if (this.switchmode.getValue() == SwitchMode.Silent && slot != -1) {
                ...
                AutoCrystal.mc.player.connection.sendPacket(new CPacketHeldItemChange(old));
            }
        }
    }
    ...
    EntityPlayer getTarget() {
        ...
        for (EntityPlayer entity : AutoCrystal.mc.world.playerEntities) {
            if (AutoCrystal.mc.player == null || AutoCrystal.mc.player.isDead || entity.isDead || entity == AutoCrystal.mc.player || RenoSense.friendManager.isFriend(entity.getName()) || entity.getDistance(AutoCrystal.mc.player) > 12.0f) continue;
            this.armorTarget = false;
            ...
            if (EntityUtil.isInHole(entity) && entity.getAbsorptionAmount() + entity.getHealth() > this.facePlace.getValue().floatValue() && !this.armorTarget && this.minDamage.getValue().floatValue() > 2.2f) continue;
            if (closestPlayer == null) {
                closestPlayer = entity;
                continue;
            }
            if (!(closestPlayer.getDistance(AutoCrystal.mc.player) > entity.getDistance(AutoCrystal.mc.player))) continue;
            closestPlayer = entity;
        }
    ...
    private void manualBreaker() {
        ...
        if (this.manualTimer.passedMs(200L) && AutoCrystal.mc.gameSettings.keyBindUseItem.isKeyDown() && AutoCrystal.mc.player.getHeldItemOffhand().getItem() != Items.GOLDEN_APPLE && AutoCrystal.mc.player.inventory.getCurrentItem().getItem() != Items.GOLDEN_APPLE && AutoCrystal.mc.player.inventory.getCurrentItem().getItem() != Items.BOW && AutoCrystal.mc.player.inventory.getCurrentItem().getItem() != Items.EXPERIENCE_BOTTLE && (result = AutoCrystal.mc.objectMouseOver) != null) {
            if (result.typeOfHit.equals(RayTraceResult.Type.ENTITY)) {
                ...
                BlockPos mousePos = new BlockPos((double)AutoCrystal.mc.objectMouseOver.getBlockPos().getX(), (double)AutoCrystal.mc.objectMouseOver.getBlockPos().getY() + 1.0, (double)AutoCrystal.mc.objectMouseOver.getBlockPos().getZ());
    ...
    private float getDamageMultiplied(float damage) {
        int diff = AutoCrystal.mc.world.getDifficulty().getDifficultyId();
